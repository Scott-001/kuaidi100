...
@ddt
class TestAddNewBatch(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_addNewBatch(self):
        try:
            requests = datahandler.DataHandler.handle_data(r'D:\Project\driver_demo\yaml\addNewbatch.yaml')
